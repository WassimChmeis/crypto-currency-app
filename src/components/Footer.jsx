...
const Footer = () => {
  return (
    <>
      <div className="py-16 border-t border-gray-600 md:flex justify-between text-[18px] font-normal md:px-10 px-5 text-gray-300">
        <div className="flex justify-center items-center mb-3 md:mb-0">
          © 2023 Wassim.
          <FaConnectdevelop className="text-red-500 text-[27px]" />
        </div>
